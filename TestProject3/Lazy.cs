...
namespace csharp_tutorial2
{
    public class Lazy
    {
        ...
        {
            // Linq07 has and example of LINQ Select. This example shows more complicated
    ...
    {
        public static async Task<T> FirstOrDefaultAsync<T>(this IEnumerable<Task<T>> items,
