...
{
    public class General00
    {
        public class Hello
        {
            // This can be only set in constructor 
            // Use the as often as possible, as it is generally not recommended to use mutable class variables
            ...
            // Backing filed for a property is a common case to use private variables
            ...
            public int CurrentValue
            {
                ...
                set
                {
                    if (_myValue != value)
                    {
                        ...
                        _myValue = value;
                        // Usually here can be some on change event notifications etc.
                    }
                }
            }
            ...
            // There is something different how these are handled, so letter one can only have reference to static fields
