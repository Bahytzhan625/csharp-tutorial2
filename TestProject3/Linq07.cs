...
namespace csharp_tutorial2
{
    public class Linq07
    {
        ...
        public void Linq()
        {
            ...
            var bonusAdded = batch1.Zip(batch1bonus,
                (person, bonus) => new { person.Name, Pay = person.Salary + bonus });
        }
        ...
        public void Linq_Lazy()
        {
            ...
            // Create new Person for Timmy and Sammy
        ...
        public void K()
        {
            // Combine requests to sets that have some requesters
            ...
            requestSet = requests.Select(s => new
                {
                    RequestId = s.Key,
                    SsnList = s.Value.OrderBy(r => r.Ssn).Select(r => r.Ssn)
        ...
        public void Compare()
        {
            // All that can also be implemented with using object's Equals method
